...
echo "     module purge"
echo "     module load gcc/11.2.0 openmpi/4.1.2 fftw/3.3.10-mpi cuda/11.5.0 cudnn/8.3.3.40-11.5 .unsupported intel-oneapi-mkl/2021.4.0"
echo ""
...
echo "     export PATH=$LAMMPS_DIR/bin:$PATH"
